...
def extract_features(records, targets, extractor, catalog_db_path):
    ...
    for record, target in zip(records, targets):
        ...
        price_types.append(record.get('ebay_price_type', 'listing'))
...
def train_ebay_model():
    ...
    X, y, isbns, completeness, timestamps, price_types = extract_features(ebay_records, ebay_targets, extractor, catalog_db_path)
