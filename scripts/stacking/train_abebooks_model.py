...
Trains a GradientBoostingRegressor optimized for AbeBooks pricing prediction
...
def train_abebooks_model():
    ...
    X, y, completeness = extract_features(abebooks_records, abebooks_targets, extractor)
